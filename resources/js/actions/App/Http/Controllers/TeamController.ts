 ...
 * @see app/Http/Controllers/TeamController.php:34
 ...
 * @see app/Http/Controllers/TeamController.php:63
 * @route '/teams/create'
 */
 ...
 * @see app/Http/Controllers/TeamController.php:68
 * @route '/teams'
 */
 ...
 * @see app/Http/Controllers/TeamController.php:84
 ...
 * @see app/Http/Controllers/TeamController.php:89
 * @route '/teams/{team}'
 */
 ...
 * @see app/Http/Controllers/TeamController.php:155
 * @route '/teams/{team}'
 */
 ...
 * @see app/Http/Controllers/TeamController.php:105
...
const TeamController = { index, getTeamUsers, create, store, edit, update, destroy, assignUsers }
